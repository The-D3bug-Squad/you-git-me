...
from Tools.user_functions import get_password, get_username, validate_password, validate_username, save_user_info

class TestUserFunctions(unittest.TestCase):

    @patch("Tools.user_functions.pwinput.pwinput", return_value="securePassword123!")
    ...
    def test_save_user_info(self):
        ...
        with patch("Tools.user_functions.open", unittest.mock.mock_open()) as mock_file:
